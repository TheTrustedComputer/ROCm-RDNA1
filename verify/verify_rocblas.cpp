...
void print_matrix(const char *_NAME, const float *_MATRIX)
{
    std::cout << _NAME << ":\n";
...
int main(void)
{
    ...
    print_matrix("Matrix A", h_mat_A);
    std::cout << "\n";
    print_matrix("Matrix B", h_mat_B);
    std::cout << "\n";
    ...
    for (int i = 0; i < devices; i++)
    {
        ...
        rocblas_sgemm(handle, rocblas_operation_none, rocblas_operation_none, N, N, N, &alpha, d_mat_A, N, d_mat_B, N, &beta, d_mat_C, N);
    ...
    print_matrix("Matrix A * B", h_mat_C);
